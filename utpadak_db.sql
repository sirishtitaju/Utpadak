...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2019 at 04:19 PM
...
(7, 'kushal', 'kushal@gmail.com', 'kushal5', 'IMG_20181017_150234_037.jpg', 'sarlahi', ' itonics project', '9843816844', 'work on backend');
...
CREATE TABLE `customers` (
  ...
  `is_manufacturer` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `customers` (`customer_id`, `customer_name`, `customer_email`, `customer_pass`, `customer_state`, `customer_district`, `customer_contact`, `customer_address`, `customer_image`, `customer_ip`, `is_manufacturer`) VALUES
(8, 'KushalBadal', 'kushal@gmail.com', 'kushal5', '2', 'sarlahi', '9843816844', 'Bhaktipur', 'IMG_20181017_150234_037.jpg', '::1', 1);
...
(14, 5, 103, 1958242422, 1, 'Small', '2019-12-08', 'pending'),
(15, 5, 204, 1958242422, 3, 'Medium', '2019-12-08', 'pending'),
(16, 7, 98, 1141911549, 1, '', '2019-12-08', 'pending');
...
INSERT INTO `manufacturers` (`manufacturer_id`, `manufacturer_title`, `manufacturer_top`, `manufacturer_image`, `manufacturer_contact`, `manufacturer_email`, `store_product`, `verification_code`, `verified`, `created_at`, `modified_at`) VALUES
(16, 'kushalbadal', 'yes', 'IMG_20181017_150234_037.jpg', '9843816844', 'kushal@gmail.com', '', '', 0, '0000-00-00 00:00:00', '2019-12-08 06:17:41'),
(19, 'kushal', '', 'IMG_20181017_150234_037.jpg', '9843816844', 'kushal@gmail.com', 'yes', '', 0, '0000-00-00 00:00:00', '2019-12-09 14:42:10');
...
(12, 5, 1958242422, '5', 1, 'Small', 'pending'),
(13, 5, 1958242422, '17', 3, 'Medium', 'pending'),
(14, 7, 1141911549, '14', 1, '', 'pending');
...
INSERT INTO `products` (`product_id`, `p_cat_id`, `cat_id`, `manufacturer_name`, `date`, `product_title`, `product_img1`, `product_img2`, `product_img3`, `product_price`, `product_keywords`, `product_desc`, `product_label`, `product_sale`) VALUES
